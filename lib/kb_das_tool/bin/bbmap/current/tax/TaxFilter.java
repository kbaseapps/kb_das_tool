...
//				System.err.println("Set taxLevelE = "+TaxTree.levelToStringExtended(taxLevelE)); //123
		...
		TaxFilter filter=new TaxFilter(tableFile, treeFile, accessionFile, taxLevelE, reqLevels, include, promote, null, regex, contains);
	 ...
	 * Constructor.
	 */
	public TaxFilter(String tableFile, String treeFile, String accessionFile, int taxLevelE_, int reqLevels_,
	...
	static TaxTree loadTree(String fname){
		...
		TaxTree tt=TaxTree.loadTaxTree(fname, PRINT_STUFF ? outstream : null, true);
