...
public class ScafMap {
	...
	public static ScafMap loadReference(String fname){return loadReference(fname, null, null);}
	public static ScafMap loadReference(FileFormat ff){return loadReference(ff, null, null);}
	
	public static ScafMap loadReference(String fname, ScafMap scafMap, SamFilter samFilter){
		FileFormat ff=FileFormat.testInput(fname, FileFormat.FASTA, null, true, true);
		return loadReference(ff, scafMap, samFilter);
	}
	
	public static ScafMap loadReference(FileFormat ff, ScafMap map, SamFilter samFilter){
