...
//		if(!Whitelist.contains(value)){return false;}
	...
	public final long[] toSketchArray(){
		int maxLen=SketchObject.toSketchSize(genomeSizeBases, genomeSizeKmers, genomeSizeEstimate(), SketchObject.targetSketchSize);
//		System.err.println(genomeSizeBases+", "+genomeSizeKmers+", "+genomeSizeEstimate()+", "+SketchObject.size+" -> "+maxLen); //123
