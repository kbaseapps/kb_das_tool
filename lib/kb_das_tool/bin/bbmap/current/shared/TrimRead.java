...
public final class TrimRead implements Serializable {
	...
	public static int trimFast(Read r, boolean trimLeft, boolean trimRight, int trimq, int minResult){
		return trimFast(r, trimLeft, trimRight, trimq, minResult, 0, false);
	}
	 ...
	 * @return Number of bases trimmed
	 */
	public static int trimFast(Read r, boolean trimLeft, boolean trimRight, int trimq, int minResult, boolean trimClip){
		return trimFast(r, trimLeft, trimRight, trimq, minResult, 0, trimClip);
	}
	 ...
	 * @return Number of bases trimmed
	 */
	public static int trimFast(Read r, boolean trimLeft, boolean trimRight, int trimq, int minResult, int discardUnder, boolean trimClip){
